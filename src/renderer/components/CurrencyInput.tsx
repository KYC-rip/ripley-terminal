...
export function CurrencyInput({
  ...
  const modalContent = (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-xmr-base/90 backdrop-blur-md animate-in fade-in duration-200 p-4">
      ...
      <div className="relative w-full max-w-sm bg-xmr-base border border-xmr-green/50 shadow-[0_0_50px_rgba(0,255,65,0.1)] rounded-md overflow-hidden flex flex-col max-h-[70vh] animate-in zoom-in-95 duration-200 z-10">
        {/* Header */}
        ...
        {/* Footer Status */}
        <div className="p-2 border-t border-xmr-border bg-xmr-surface text-xs text-xmr-dim flex justify-between rounded-b-md font-mono">
