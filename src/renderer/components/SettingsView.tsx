...
import { Settings, Server, Zap, EyeOff, Check, RefreshCw } from 'lucide-react';
          ...
          <Card className="p-6 bg-xmr-surface border-xmr-border/40 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className={`flex items-center justify-between p-4 border rounded-sm transition-all ${isStagenet ? 'bg-xmr-accent/10 border-xmr-accent/40' : 'bg-xmr-green/5 border-xmr-border opacity-60'}`}>
                <div className="space-y-1">
                  <div className="flex items-center gap-2"><RefreshCw size={14} className={isStagenet ? "text-xmr-accent animate-spin" : "text-xmr-dim"} /><span className={`text-[10px] font-black uppercase ${isStagenet ? 'text-xmr-accent' : 'text-xmr-green'}`}>Stagenet_Mode</span></div>
