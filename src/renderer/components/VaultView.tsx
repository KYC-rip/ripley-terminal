    ...
    <div className="max-w-6xl mx-auto space-y-6 py-2 animate-in fade-in zoom-in-95 duration-300 font-black relative">
      ...
      <div className="flex justify-between items-end border-b border-xmr-border/30 pb-4 relative z-10 font-black">
        ...
        <div className="flex gap-2 font-black">
          ...
          <button onClick={refresh} className="px-3 py-1.5 border border-xmr-border text-[9px] hover:bg-xmr-green/10 transition-all flex items-center gap-2 cursor-pointer uppercase font-black"><RefreshCw size={10} className={status === StealthStep.SYNCING || isSending ? 'animate-spin' : ''} /> Sync_Ledger</button>
        </div>
      </div>
